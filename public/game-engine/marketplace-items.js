...
(function () {
  ...
  var EQUIPMENT = [
    ...
    // (fxTier-3, glowing) weapons below have no tokenPrice — real currency only.
    { id:'emberwood_maul', name:'Emberwood Maul', type:'weapon', slot:SLOTS.WEAPON,
      price:2.0, tokenPrice:5000, fxTier:2, fxColor:'#d98a4a', effect:{ atkBonus:18, behavior:'knockback' },
    ...
    { id:'ironbolt_crossbow', name:'Ironbolt Crossbow', type:'weapon', slot:SLOTS.WEAPON,
      price:3.0, tokenPrice:8000, fxTier:2, fxColor:'#e0b25a', effect:{ atkBonus:24, behavior:'ranged' },
    ...
    { id:'argent_waraxe', name:'Argent Waraxe', type:'weapon', slot:SLOTS.WEAPON,
      price:4.0, tokenPrice:12000, fxTier:2, fxColor:'#cfd8e3', effect:{ atkBonus:30, behavior:'cleave' },
