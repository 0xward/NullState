...
const DECOR_TYPES = {
  ...
  crystal:  { hp:2, w:26, h:40, label:'Cave Crystal',    loot:[['relic',1,20],['item',2,20],['xp',30,20],['none',0,15]] },
  tablet:   { hp:2, w:36, h:48, label:'Engraved Tablet', loot:[['relic',1,30],['item',3,25],['xp',40,25]] },
  statue:   { hp:3, w:36, h:62, label:'Weathered Idol',  loot:[['relic',1,30],['item',3,30],['xp',50,20]] },
