  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-[rgba(0,0,0,0.95)] p-4 sm:p-6 overflow-y-auto">
      ...
      <div className="relative z-10 max-w-3xl w-full mx-auto">
        ...
        <p className="-mt-6 mb-8 text-center font-mono text-[9px] text-null-muted">
            ...
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
              {stash.map((it) => (
                ...
                >
                  ...
                  <div className="text-null-amber text-[9px]">{Math.round(it.burnValue)} Point</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div>
            ...
            {burns.length === 0 ? (
              <p className="text-null-muted font-mono text-sm py-6 text-center">
                No burns recorded yet this season — burn items from your inventory in-game to convert
                them into NullState Point instantly.
              </p>
            ) : (
                ...
                {burns.map((b) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-2 mb-1.5">
                      ...
                      <span className="text-null-green font-bold">+{Math.round(b.totalValue)} NullState Point</span>
                    </div>
                    ...
                    <div className="mt-1.5 text-[10px]">
                      <span className="text-null-green">✓ credited instantly</span>
                    </div>
                  </div>
                ))}
              </div>
