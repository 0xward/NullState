...
const TYPED_LINES = [
  ...
  '> loading AI_DM module: GROQ_LLM_70B',
  '> world_event: RAID BOSS spawned',
...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-32 overflow-hidden z-[2]">
      ...
      >
        <span className="block text-null-white">NULL</span>
        <span
      ...
      >
        The first AI dungeon master RPG deployed on Celo.
        Pay 0.01 CELO to act. Lose your HP, lose your progress.
      ...
      {/* Tech tags — plain text, no emoji logos */}
      <div
      ...
      >
        {[
          ...
          { label: 'AI DM · GROQ 70B', active: true },
          { label: 'RAID BOSS LIVE', active: true },
