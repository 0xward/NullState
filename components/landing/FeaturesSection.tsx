  ...
  return (
    <>
      <style>{`
        ...
        .enemy-sprite { animation: enemyIdle 2.2s ease-in-out infinite; image-rendering: pixelated; }
        .enemy-card:hover .enemy-sprite { animation: enemyIdle 1s ease-in-out infinite; filter: drop-shadow(0 0 8px rgba(255,34,68,0.7)); }
      `}</style>
