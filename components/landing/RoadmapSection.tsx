...
export default function RoadmapSection() {
  const phases = [
    {
      phase: 'PHASE 01', timing: 'NOW', title: 'Genesis', active: true,
      items: ['Real-time dungeon engine live', 'MiniPay deep integration', 'On-chain NULL_STRIKE', 'Celo Passport verify', 'Social combat (Twitter)', 'Raid Boss v1'],
    },
    {
      phase: 'PHASE 02', timing: 'Q3 2025', title: 'Expansion', active: false,
      items: ['Artifact NFT minting (ERC-721)', 'Zone unlocks (5 new areas)', 'World Events v1', 'Leaderboard on-chain', 'Referral rewards', 'Discord integration'],
    },
    {
      phase: 'PHASE 03', timing: 'Q4 2025', title: 'Protocol Wars', active: false,
      items: ['Multiplayer raid system', 'Social combat layer v2', 'DAO governance (token)', 'Lore NFT drops', 'PvP arena mode', 'Mobile app (React Native)'],
    },
    {
      phase: 'PHASE 04', timing: '2026', title: 'Null Protocol', active: false,
      items: ['Full world persistence', 'Cross-chain bridges', 'Animated pixel client', 'Tournament seasons', 'SDK for third-party zones', 'Web3 game passport'],
    },
  ]
