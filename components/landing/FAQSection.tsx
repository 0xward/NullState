...
const faqs = [
  ...
  { q: 'Do I need a wallet app to play?', a: "Yes, but setup is instant. NullState is built for MiniPay — just open the MiniPay app (available on Android/iOS in Africa and Southeast Asia), and you're ready to play with built-in CELO balance. No seed phrases, no complex onboarding. Any Celo-compatible wallet (MetaMask, Valora) also works." },
  { q: 'What is CELO and how do I get it?', a: 'CELO is the native currency of the Celo blockchain. You can get it through MiniPay, or through exchanges like Binance, Coinbase, or Uniswap. Each game action costs 0.01 CELO. Network fees on Celo average $0.001, so you pay almost nothing in infrastructure costs.' },
  ...
  { q: 'What is a Raid Boss and how does social combat work?', a: 'Raid Bosses are massively powerful world enemies that all players fight collectively. Every player in the game can contribute damage. The top contributor when the boss falls claims special rewards. Raid Boss social integration is coming in a future season.' },
  ...
  { q: 'Is the code open source?', a: "Yes. NullState is MIT licensed and the full smart contract and frontend code is available on GitHub. We believe in building in public on Celo. Forks are welcome — you will need your own Firebase project, WalletConnect project ID, and MiniPay integration." },
]
