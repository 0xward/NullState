...
const faqs = [
  ...
  { q: 'What is USDm and how do I get it?', a: 'USDm (Mento Dollar) is a stablecoin on Celo, worth about $1. You can receive it through MiniPay or an exchange that supports Celo. NullState uses USDm (and USDC/USDT) for the Marketplace, Season Pass, and Vault Quest rewards — not CELO directly.' },
  ...
  { q: 'What is the Golden Key and the Treasure Vault?', a: 'The Golden Key and a Code Paper occasionally drop from certain containers as you loot — capped at one of each per wallet per week. Bring both to the sealed Vault door and enter the weekly 4-digit code (3 attempts) for a real USDm reward.' },
  { q: 'How does combat work?', a: "It's real-time, not turn-based. Move with WASD/arrows or the on-screen joystick, auto-attack nearby enemies, smash containers for loot, and clear every enemy on a floor to unlock the next one via the Lift. When it counts, trigger NULL_STRIKE — an on-chain ultimate that costs a flat 0.005 USDm." },
  ...
  { q: 'How does the leaderboard work?', a: 'Each month, players are ranked by a combined score across USDm earned, items collected, kills, active days, and vault codes solved. The top 3 at season end split a real USDm prize pool.' },
