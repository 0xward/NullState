{/* DRAFT: reviewed against docs/data-safety.md and app data flows. Legal review by 0xward recommended before final submission. Items specifically requiring 0xward confirmation: exact data retention timelines and formal deletion request process. */}
...
export const metadata = {
  ...
  description: 'Privacy Policy for NULL_STATE, a Web3 RPG on Celo. Operated by 0xward.',
}
        ...
        <div className="flex flex-col gap-12 text-[15px] leading-relaxed text-null-muted">
          ...
          <section>
            ...
            <div className="pl-4">
              <p>
                ...
                operated by <strong className="text-null-white">0xward</strong>. This Privacy
          ...
          <section>
            ...
            <div className="pl-4 flex flex-col gap-3">
              ...
              <ul className="flex flex-col gap-2 font-mono text-sm">
                {[
                  'Encryption at rest for sensitive fields (e.g. vault codes are not stored in plaintext)',
          ...
          <section>
            ...
            <div className="pl-4 flex flex-col gap-3">
              ...
              <p className="text-null-amber font-mono text-xs border border-[rgba(255,170,0,0.2)] px-3 py-2">
                [Data retention &amp; deletion request process — TBD by 0xward, e.g. specify
          ...
          <section>
            ...
            <div className="pl-4 flex flex-col gap-3">
              <p>
                For privacy questions, data requests, or general support, contact the 0xward
